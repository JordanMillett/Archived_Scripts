...
public class SettingsManager : MonoBehaviour
{
    ...
    void LoadSettings()
    {
        ...
        try
        {
            ...
            Settings._mouseSensitivity = int.Parse(settingsLines[3]);
            Settings._invertedLook = int.Parse(settingsLines[4]) == 1;

            Settings._FOV = int.Parse(settingsLines[5]);
            Settings._planeFOV = int.Parse(settingsLines[6]);

            Settings._masterVolume = int.Parse(settingsLines[7]);
            Settings._sfxVolume = int.Parse(settingsLines[8]);
    ...
    void SettingsToFile()
    {
        ...
        settingsLines += Settings._FOV + "\n";
        settingsLines += Settings._planeFOV + "\n";
